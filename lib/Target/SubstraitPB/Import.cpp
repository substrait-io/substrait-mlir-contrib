...
/// than NULLABILITY_REQUIRED, i.e., it treats NULLABILITY_UNSPECIFIED as
/// nullable. This is a known, temporary simplification: since
/// `NullableType` carries no `unspecified` state, UNSPECIFIED must be promoted
/// to NULLABLE on import. The Substrait spec states that consumers MUST treat
/// NULLABILITY_UNSPECIFIED as NULLABILITY_NULLABLE, so no semantics are lost.
/// TODO(ingomueller-net): eliminate this deviation by carrying all three
/// nullability values.
