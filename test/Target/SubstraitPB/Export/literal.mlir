...
// CHECK:             expressions {
// CHECK-NEXT:          literal {
// CHECK-NEXT:            fixed_binary: "4,5,6,7"
...
substrait.plan version 0 : 42 : 1 {
  relation {
    ...
    ^bb0(%arg : tuple<si1>):
      %fixed_binary = literal "4,5,6,7" : !substrait.fixed_binary<4>
      yield %fixed_binary : !substrait.fixed_binary<4>
    }
...
substrait.plan version 0 : 42 : 1 {
  relation {
    ...
    ^bb0(%arg0: tuple<si1>):
      %2 = literal "hello" : !substrait.var_char<6>
...
substrait.plan version 0 : 42 : 1 {
  relation {
    ...
    ^bb0(%arg0: tuple<si1>):
      %2 = literal "hello" : !substrait.fixed_char<5>
