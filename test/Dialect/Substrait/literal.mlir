...
// CHECK-NEXT:    %[[V1:.*]] = project %[[V0]] : tuple<si1> -> tuple<si1, !substrait.fixed_binary<4>> {
// CHECK-NEXT:    ^[[BB0:.*]](%[[ARG0:.*]]: tuple<si1>):
// CHECK-NEXT:      %[[V2:.*]] = literal "4,5,6,7" : !substrait.fixed_binary<4>
// CHECK-NEXT:      yield %[[V2]] : !substrait.fixed_binary<4>
// CHECK-NEXT:    }
// CHECK-NEXT:    yield %[[V1]] : tuple<si1, !substrait.fixed_binary<4>

substrait.plan version 0 : 42 : 1 {
  relation {
    %0 = named_table @t1 as ["a"] : tuple<si1>
    %1 = project %0 : tuple<si1> -> tuple<si1, !substrait.fixed_binary<4>> {
    ^bb0(%arg : tuple<si1>):
      %bytes = literal "4,5,6,7" : !substrait.fixed_binary<4>
      yield %bytes : !substrait.fixed_binary<4>
    }
    yield %1 : tuple<si1, !substrait.fixed_binary<4>>
  }
}
...
// CHECK-NEXT:    ^[[BB0:.*]](%[[ARG0:.*]]: tuple<si1>):
// CHECK-NEXT:      %[[V2:.*]] = literal "hello" : !substrait.var_char<6>
...
substrait.plan version 0 : 42 : 1 {
  relation {
    ...
    ^bb0(%arg : tuple<si1>):
      %fixed_char = literal "hello" : !substrait.var_char<6>
...
// CHECK-NEXT:    ^[[BB0:.*]](%[[ARG0:.*]]: tuple<si1>):
// CHECK-NEXT:      %[[V2:.*]] = literal "hello" : !substrait.fixed_char<5>
...
substrait.plan version 0 : 42 : 1 {
  relation {
    ...
    ^bb0(%arg : tuple<si1>):
      %fixed_char = literal "hello" : !substrait.fixed_char<5>
