...
// CHECK-NEXT:      %[[V2:.*]] = literal #substrait.interval_year_month<2024y 1m> : !substrait.interval_year_month 
// CHECK-NEXT:      %[[V3:.*]] = literal #substrait.interval_day_second<9d 8000s> : !substrait.interval_day_second
