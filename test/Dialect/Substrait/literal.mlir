...
// CHECK-NEXT:   relation
// CHECK:         %[[V0:.*]] = named_table
// CHECK-NEXT:    %[[V1:.*]] = project %[[V0]] : <si1> -> <si1, timestamp, !substrait.timestamp_tz> {
// CHECK-NEXT:    ^[[BB0:.*]](%[[ARG0:.*]]: tuple<si1>):
...
// CHECK-NEXT:    }
// CHECK-NEXT:    yield %[[V1]] : !substrait.relation<si1, timestamp, !substrait.timestamp_tz>

substrait.plan version 0 : 42 : 1 {
  relation {
    %0 = named_table @t1 as ["a"] : <si1>
    %1 = project %0 : <si1> -> <si1, timestamp, !substrait.timestamp_tz> {
    ^bb0(%arg : tuple<si1>):
    ...
    yield %1 : !substrait.relation<si1, timestamp, !substrait.timestamp_tz>
  }
}
